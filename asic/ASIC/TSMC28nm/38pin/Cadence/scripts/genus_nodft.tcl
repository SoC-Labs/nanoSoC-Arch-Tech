...
read_hdl -define POWER_PINS $env(SOCLABS_NANOSOC_ARCH_TECH_DIR)/ASIC/nanosoc_chip_pads/tsmc28hpcp/nanosoc_chip_pads_38pin.v
...
## -- Read constraints -- ##
read_sdc $::env(SOCLABS_NANOSOC_ARCH_TECH_DIR)/ASIC/TSMC28nm/constraints.sdc 
