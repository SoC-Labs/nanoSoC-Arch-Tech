...
create_relative_floorplan -orient R90 -ref_type core_boundary -horizontal_edge_separate {1  0  1} -vertical_edge_separate {2  0 2} -place u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1_u_sram_1_u_sram_genblk1.u_sram
create_relative_floorplan -orient R90 -ref_type object -horizontal_edge_separate {1  0  1} -vertical_edge_separate {1  -1  3} -place  u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0_u_sram_0_u_sram_genblk1.u_sram -ref u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1_u_sram_1_u_sram_genblk1.u_sram
create_relative_floorplan -orient R90 -ref_type object -horizontal_edge_separate {1  0  1} -vertical_edge_separate {1  -1  3} -place  u_nanosoc_chip/u_system/u_ss_cpu_u_region_dmem_0_u_dmem_0_u_sram_genblk1.u_sram -ref u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0_u_sram_0_u_sram_genblk1.u_sram
