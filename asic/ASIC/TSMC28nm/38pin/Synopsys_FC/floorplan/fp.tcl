...
set cellInst [get_cells { \
    u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0/u_sram_0/u_sram/genblk1.u_sram \
    }]
set_attribute -quiet -objects $cellInst -name orientation -value R0
...
set cellInst [get_cells { \
    u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1/u_sram_1/u_sram/genblk1.u_sram \
    }]
set_attribute -quiet -objects $cellInst -name orientation -value R0
set_attribute -quiet -objects $cellInst -name origin -value { 786.4450 \
    1187.1400 }
...
set cellInst [get_cells { \
    u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_synopsys_ts \
    }]
set_attribute -quiet -objects $cellInst -name orientation -value R0
...
set cellInst [get_cells { \
    u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_synopsys_pd \
    }]
set_attribute -quiet -objects $cellInst -name orientation -value R0
