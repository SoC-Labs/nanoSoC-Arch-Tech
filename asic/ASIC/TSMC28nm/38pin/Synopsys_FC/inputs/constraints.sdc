...
create_generated_clock -source [get_ports CLK] -name "SNPS_TS_CLK" -divide_by 120 [get_pins u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_ts_clk_div/clk_o ]
create_generated_clock -source [get_ports CLK] -name "SNPS_PD_CLK" -divide_by 30  [get_pins u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_pd_clk_div/clk_o ]
