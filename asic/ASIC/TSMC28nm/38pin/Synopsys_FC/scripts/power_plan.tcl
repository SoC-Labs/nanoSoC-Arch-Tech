...
connect_pg_net -net {VDD} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0/u_sram_0/u_sram/genblk1.u_sram/VDD}]
connect_pg_net -net {VDD} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1/u_sram_1/u_sram/genblk1.u_sram/VDD}]
...
connect_pg_net -net {VSS} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0/u_sram_0/u_sram/genblk1.u_sram/VSS}]
connect_pg_net -net {VSS} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1/u_sram_1/u_sram/genblk1.u_sram/VSS}]
...
# Synopsys PVT
connect_pg_net -net {VDD} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_synopsys_ts/VDD}]
connect_pg_net -net {VDD} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_synopsys_ts/VDDA}]
connect_pg_net -net {VSS} [get_pins -design [current_block] -quiet -physical_context {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_synopsys_ts/VSS}]
connect_pg_net -net {VSS} [get_pins {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_synopsys_pd/VSS}]
connect_pg_net -net {VDD} [get_pins {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_synopsys_pd/VDD}]
connect_pg_net -net {VSS} [get_pins {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_synopsys_pd/VDDA}]
...
set_pg_strategy snps_pd_strat -macros {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_pd0.u_snps_PVT_pd0/u_synopsys_pd} \
...
set_pg_strategy snps_ts_strat -macros {u_nanosoc_chip/u_system/u_ss_systemctrl/u_region_soc_peripheral/u_nanosoc_soc_peripheral_snps_pvt_ss/gen_snps_PVT_ts0.u_snps_PVT_ts0/u_synopsys_ts} \
