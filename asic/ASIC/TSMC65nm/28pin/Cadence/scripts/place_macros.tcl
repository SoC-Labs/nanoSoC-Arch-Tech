...
create_relative_floorplan -ref_type core_boundary -horizontal_edge_separate {1  -4.8  1} -vertical_edge_separate {2  0  2} -place u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_genblk1.u_rf_sp_hdf
create_relative_floorplan -ref_type object -horizontal_edge_separate {3  -18.0  1} -vertical_edge_separate {3  0  3} -place u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_1_u_sram_1_u_sram_genblk1.u_rf_sp_hdf -ref u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_genblk1.u_rf_sp_hdf
...
create_place_halo -halo_deltas {2 2 0 2} -insts u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_genblk1.u_rf_sp_hdf
create_place_halo -halo_deltas {2 2 0 2} -insts u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_1_u_sram_1_u_sram_genblk1.u_rf_sp_hdf
