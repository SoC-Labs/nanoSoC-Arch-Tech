...
create_relative_floorplan -ref_type core_boundary -horizontal_edge_separate {1  -30  1} -vertical_edge_separate {2  -20  2} -place u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_u_rf_sp_hdf
create_relative_floorplan -ref_type object -horizontal_edge_separate {3  -30  1} -vertical_edge_separate {3  0  3} -place u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_1_u_sram_1_u_sram_u_rf_sp_hdf -ref u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_u_rf_sp_hdf
create_relative_floorplan -ref_type object -horizontal_edge_separate {3  -30  1} -vertical_edge_separate {3  0  3} -place u_nanosoc_chip_u_system_u_ss_cpu_u_region_imem_0_u_imem_0_u_sram_u_rf_sp_hdf -ref u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_1_u_sram_1_u_sram_u_rf_sp_hdf
...
create_place_halo -halo_deltas {5 5 5 5} -insts u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_0_u_sram_0_u_sram_u_rf_sp_hdf
create_place_halo -halo_deltas {5 5 5 5} -insts u_nanosoc_chip_u_system_u_ss_expansion_u_region_sram_1_u_sram_1_u_sram_u_rf_sp_hdf
