...
set_macro_relative_location -target_object [get_cell {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0/u_sram_0/u_sram/u_rf_sp_hdf}] -target_orientation R0 -target_corner tr -anchor_corner tr -offset {-0.1 -0.05} -offset_type scalable
set_macro_relative_location -target_object [get_cell {u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1/u_sram_1/u_sram/u_rf_sp_hdf}] -target_orientation R0 -target_corner tr -anchor_corner tr -offset {-0.1 -0.27} -offset_type scalable
...
set_attribute -objects [get_cells u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_0/u_sram_0/u_sram/u_rf_sp_hdf] -name physical_status -value fixed
set_attribute -objects [get_cells u_nanosoc_chip/u_system/u_ss_expansion/u_region_sram_1/u_sram_1/u_sram/u_rf_sp_hdf] -name physical_status -value fixed
