...
/*
 * If the build system provides the auto-generated address map header
 * (nanosoc_memmap.h, generated from the YAML address map by
 * gen_firmware_config.py), use it as the single source of truth.
...
#ifndef NANOSOC_SOC_PERIPHERAL_BASE
#define NANOSOC_SOC_PERIPHERAL_BASE (0x40000000UL)
#endif
#ifndef NANOSOC_DMAC_CTRL_BASE
#define NANOSOC_DMAC_CTRL_BASE      (0x50000000UL)
#endif
...
#define CMSDK_PERIPH_BASE       (NANOSOC_SOC_PERIPHERAL_BASE)  /*!< (Peripheral) Base Address */

#define CMSDK_RAM_BASE          (NANOSOC_DMEM_0_BASE)
#define CMSDK_APB_BASE          (NANOSOC_SOC_PERIPHERAL_BASE)
#define CMSDK_AHB_BASE          (NANOSOC_SOC_PERIPHERAL_BASE + 0x10000UL)
