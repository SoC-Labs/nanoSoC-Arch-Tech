...
`endif
  ...
  always @(reg_addr or reg_remap or reg_pmuenable or ECOREVNUM or
           reg_lockupreset or reg_resetinfo or reg_read_enable) begin
    case (reg_read_enable)
      1'b1: begin
        if (reg_addr[11:5] == 7'h00) begin
          ...
          case (reg_addr[5:2])
            4'h4: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID4; // 0xFD0 Peripheral ID 4
            4'h5: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID5; // 0xFD4 Peripheral ID 5
            4'h6: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID6; // 0xFD8 Peripheral ID 6
            4'h7: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID7; // 0xFDC Peripheral ID 7
            4'h8: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID0; // 0xFE0 Peripheral ID 0
            4'h9: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID1; // 0xFE4 Peripheral ID 1
            4'hA: read_mux = ARM_CMSDK_CM0_SYSCTRL_PID2; // 0xFE8 Peripheral ID 2
            4'hB: read_mux = {ARM_CMSDK_CM0_SYSCTRL_PID3[31:8], ECOREVNUM[3:0], 4'h0}; // 0xFEC Peripheral ID 3
            4'hC: read_mux = ARM_CMSDK_CM0_SYSCTRL_CID0; // 0xFF0 Component ID 0
            4'hD: read_mux = ARM_CMSDK_CM0_SYSCTRL_CID1; // 0xFF4 Component ID 1
            4'hE: read_mux = ARM_CMSDK_CM0_SYSCTRL_CID2; // 0xFF8 Component ID 2
            4'hF: read_mux = ARM_CMSDK_CM0_SYSCTRL_CID3; // 0xFFC Component ID 3
      ...
      1'b0: begin // read_enable is not active
        read_mux = {32{1'b0}};
      end
      default:
        read_mux = {32{1'bx}};
...
`endif
  ...
  // Write 1 to clear
  assign nxt_resetinfo[0] = ((~(reg_resetinfo_write & HWDATA[0])) & reg_resetinfo[0]) | SYSRESETREQ;
  assign nxt_resetinfo[1] = ((~(reg_resetinfo_write & HWDATA[1])) & reg_resetinfo[1]) | WDOGRESETREQ;
  assign nxt_resetinfo[2] = ((~(reg_resetinfo_write & HWDATA[2])) & reg_resetinfo[2]) | (reg_lockupreset & LOCKUP);
