...
`endif
 ...
 // --------------------------------------------------------------------------------
  ...
  // Preload EXP rams
  localparam aw_sram_0 = u_nanosoc_chip_pads.u_nanosoc_chip.u_system.SRAM_0_RAM_ADDR_W;
  localparam aw_sram_1 = u_nanosoc_chip_pads.u_nanosoc_chip.u_system.SRAM_1_RAM_ADDR_W;

  localparam awt_sram_0 = ((1<<(aw_sram_0-2))-1);
  localparam awt_sram_1 = ((1<<(aw_sram_1-2))-1);

  reg [7:0] fileimage_l [((1<<aw_sram_0)-1):0];
  reg [7:0] fileimage_h [((1<<aw_sram_1)-1):0];
  integer i,j;

  initial begin
    $readmemh("sram_0.hex", fileimage_l); 
    for (i=0;i<awt_sram_0;i=i+1) begin 
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_0.u_sram_0.u_sram.BRAM0[i] = fileimage_l[ 4*i];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_0.u_sram_0.u_sram.BRAM1[i] = fileimage_l[(4*i)+1];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_0.u_sram_0.u_sram.BRAM2[i] = fileimage_l[(4*i)+2];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_0.u_sram_0.u_sram.BRAM3[i] = fileimage_l[(4*i)+3];
    end
    $readmemh("sram_1.hex", fileimage_h); 
    for (i=0;i<awt_sram_1;i=i+1) begin 
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_1.u_sram_1.u_sram.BRAM0[i] = fileimage_h[ 4*i];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_1.u_sram_1.u_sram.BRAM1[i] = fileimage_h[(4*i)+1];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_1.u_sram_1.u_sram.BRAM2[i] = fileimage_h[(4*i)+2];
      u_nanosoc_chip_pads.u_nanosoc_chip.u_system.u_ss_expansion.u_region_sram_1.u_sram_1.u_sram.BRAM3[i] = fileimage_h[(4*i)+3];
    end
  end
